...
$$P_1^{	ext{sat}} = \exp\left(15.9008 - rac{2788.51}{373.15 - 52.36}
ight) = \exp(7.196) = 1332.9\ 	ext{kPa}$$

$$P_2^{	ext{sat}} = \exp\left(16.0137 - rac{3096.52}{373.15 - 53.67}
ight) = \exp(6.304) = 547.5\ 	ext{kPa}$$

$$P_3^{	ext{sat}} = \exp\left(16.0963 - rac{3346.65}{373.15 - 57.84}
...
$$K_i = rac{P_i^{	ext{sat}}}{P}$$

$$K_1 = rac{1332.9}{101.3} = 13.16,\quad
K_2 = rac{547.5}{101.3} = 5.41,\quad
K_3 = rac{232.0}{101.3} = 2.29$$

### 4. 核实闪蒸条件

$$\sum K_i z_i = 13.16 	imes 0.60 + 5.41 	imes 0.25 + 2.29 	imes 0.15 = 9.64 > 1$$

$$\sum rac{z_i}{K_i} = rac{0.60}{13.16} + rac{0.25}{5.41} + rac{0.15}{2.29} = 0.0456 + 0.0462 + 0.0655 = 0.1573 < 1$$
